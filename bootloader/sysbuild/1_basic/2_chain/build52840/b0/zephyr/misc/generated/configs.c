...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IS_SECURE_BOOTLOADER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IS_BOOTLOADER_IMG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SECURE_BOOT_CRYPTO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_ECDSA_SECP256R1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_SHA256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_SIGNATURE_LEN, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_PUBLIC_KEY_LEN, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_HASH_LEN, 32);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_CRYPTO_CC310_ECDSA_SECP256R1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_CRYPTO_CC310_SHA256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_ROT_VERIFY_EXT_API_UNUSED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_ROT_VERIFY_EXT_API_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_ROT_VERIFY_EXT_API_ID, 0x1001);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_ROT_VERIFY_EXT_API_FLAGS, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_ROT_VERIFY_EXT_API_VER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_ROT_VERIFY_EXT_API_MAX_VER, 255);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_UNUSED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_ID, 0x1002);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_FLAGS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_VER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_MAX_VER, 255);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_UNUSED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_ID, 0x1003);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_FLAGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_VER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_MAX_VER, 255);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_CRYPTO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_CRYPTO_LOG_LEVEL, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SECURE_BOOT_VALIDATION, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_VALIDATE_FW_EXT_API_UNUSED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_VALIDATE_FW_EXT_API_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_VALIDATE_FW_EXT_API_ID, 0x1101);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_VALIDATE_FW_EXT_API_FLAGS, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_VALIDATE_FW_EXT_API_VER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_VALIDATE_FW_EXT_API_MAX_VER, 255);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_VALIDATE_FW_SIGNATURE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SECURE_BOOT_VALIDATION_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SECURE_BOOT_VALIDATION_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SECURE_BOOT_STORAGE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FW_INFO_PROVIDE_ENABLE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_API_PROVIDE_EXT_API_UNUSED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_API_PROVIDE_EXT_API_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_API_PROVIDE_EXT_API_ID, 0x1200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_API_PROVIDE_EXT_API_FLAGS, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_API_PROVIDE_EXT_API_VER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EXT_API_PROVIDE_EXT_API_MAX_VER, 255);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_PATCH_WARN, 1);
