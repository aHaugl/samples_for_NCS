...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PM_PARTITION_SIZE_MCUBOOT, 0xbe00);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_USE_NRF_EXTERNAL_CRYPTO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_NRF_EXTERNAL_CRYPTO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UPDATEABLE_IMAGE_NUMBER, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_DOWNGRADE_PREVENTION, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_WATCHDOG_FEED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_WATCHDOG_FEED_NRFX_WDT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_TRANSPORT_NETBUF_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_CRYPTO_CLIENT_ECDSA_SECP256R1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SB_CRYPTO_CLIENT_SHA256, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_ROT_VERIFY_EXT_API_UNUSED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_REQUIRED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SHA256_EXT_API_AT_LEAST_REQUIRED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_REQUIRED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BL_SECP256R1_EXT_API_AT_LEAST_REQUIRED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_MCUBOOT_S0_S1_VERSION_MAJOR, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_MCUBOOT_S0_S1_VERSION_MINOR, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_MCUBOOT_S0_S1_VERSION_REVISION, 0);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_MCUBOOT_S0_S1_VERSION_BUILD_NUMBER, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NCS_IS_VARIANT_IMAGE, 1);
