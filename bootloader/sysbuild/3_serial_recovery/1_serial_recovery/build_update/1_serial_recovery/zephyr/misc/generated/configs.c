...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_IMGTOOL_OVERWRITE_ONLY, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_EXTRA_IMGTOOL_ARGS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUBOOT_BOOTLOADER_MODE_SINGLE_APP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x77000);
