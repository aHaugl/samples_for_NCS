...
``west ncs-provision upload -k keys/mcuboot_ed25519_priv_a.pem --keyname UROT_PUBKEY -s nrf54l15`` and ``west ncs-provision upload -k keys/nsib_ed25519_priv_a.pem --keyname BL_PUBKEY -s nrf54l15`` for NSIB
