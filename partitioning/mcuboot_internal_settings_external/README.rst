...
Overview
********
This is a modification of the Zephyr settings sample that showcases how to set up 
MCUboot primary and secondary application slot on the internal flash and settings partition 
the external flash through the use of static partitioning and use of configuration.
